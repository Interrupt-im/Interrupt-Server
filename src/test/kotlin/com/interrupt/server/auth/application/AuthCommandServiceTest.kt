...
class AuthCommandServiceTest : BehaviorSpec({
    ...
    val jwtService = FakeJwtService()
    val memberQueryRepository = FakeMemberQueryRepository()
    val tokenRepository = FakeTokenRepository()
    val authCommandService = AuthCommandService(memberQueryRepository, FakePasswordService(), jwtService, tokenRepository, tokenRepository)
